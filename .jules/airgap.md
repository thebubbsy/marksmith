...
**Action:** The CI failed because the `ci.yml` file is looking for `marksmith-v2/MdToPdf/MdToPdf.csproj` instead of `marksmith-v2/MarkSmith.Desktop/MarkSmith.Desktop.csproj` since we restructured the codebase for version 2 (Marksmith v2).
